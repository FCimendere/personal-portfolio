...
const navigation = [
  {
    name: "LinkedIn",
    title: "LinkedIn",
    href: "https://www.linkedin.com/in/fulya-cimendere/",
    target: "_blank",
  ...
  },
  {
    name: "GitHub",
    title: "GitHub",
    href: "https://github.com/FCimendere",
    target: "_blank",
    ...
    svg: (
      ...
      >
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d='M75.916 54.2 122.542 0h-11.05L71.008 47.06 38.672 0H1.376l48.898 71.164L1.376 128h11.05L55.18 78.303 89.328 128h37.296L75.913 54.2ZM60.782 71.79l-4.955-7.086-39.42-56.386h16.972L65.19 53.824l4.954 7.086 41.353 59.15h-16.97L60.782 71.793Z" fill="#000" style="stroke-width:.104373'
        ></path>
      </svg>
    ),
    current: false,
  },
  {
    name: "Medium",
    title: "Medium",
    href: "https://medium.com/@fulyacoskun.87",
    target: "_blank",
    ariaLabel: "Medium (opens in a new tab)",
    svg: (
      <svg
