...
const navigation = [
    ...
    { 
        ...
        svg: (<svg 
                ...
                >
                    <g fill='#181616'>
                    <path fill-rule='evenodd' clip-rule='evenodd' d='M75.916 54.2 122.542 0h-11.05L71.008 47.06 38.672 0H1.376l48.898 71.164L1.376 128h11.05L55.18 78.303 89.328 128h37.296L75.913 54.2ZM60.782 71.79l-4.955-7.086-39.42-56.386h16.972L65.19 53.824l4.954 7.086 41.353 59.15h-16.97L60.782 71.793Z" fill="#000" style="stroke-width:.104373'></path></g>
                </svg>),
        current: false  },
]
            ...
            <div className='relative flex h-16 items-center justify-between'>
                ...
                <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                    <div className="flex shrink-0 items-center">
                        <p className='h-8 w-auto text-black'>Follow Me <span>&#8212;</span></p>
                    </div>
